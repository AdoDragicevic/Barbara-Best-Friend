        ...
        <main className="Room">
            ...
            <div className="Room__content">
                ...
                <div className="pos-fix-bottom">
                    <Link className="Room__btn btn" to="/">Return <i className="far fa-arrow-alt-circle-left"></i></Link>
                    <Link className="Room__btn Room__btn--more btn" to="/room">More <i className="fas fa-spinner"></i></Link>
                </div>
            </div>
        </main>
    )
